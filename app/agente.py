...
Abreviaciones de género y rosca (pedidos cortos): género 'm'=Macho, 'f'=Hembra (female, del inglés), 'h'=Hembra. Inicial de rosca: 'j'=JIC, 'n'=NPT, 'b'=BSP, 'o'=ORFS. Pueden venir pegadas género+rosca: 'mj'=Macho JIC, 'fj'=Hembra JIC, 'mn'=Macho NPT, 'fn'=Hembra NPT. 'bushing' (o 'bushin'/'busing') = ADAPTADOR (macho×hembra según los géneros indicados; aplica la convención MACHO primero). Ej: "bushing 20 mj -16 fj = 5" → tipo="ADAP MACHO JIC X HEMBRA JIC", medidas=["1 1/4","1"], cantidad=5. Ej: "bushing mn 8 - fj 6" → tipo="ADAP MACHO NPT X HEMBRA JIC", medidas=["1/2","3/8"].
...
bushing / bushin / busing = ADAPTADOR (macho×hembra según los géneros; convención MACHO primero). Ej: "bushing 20 mj -16 fj = 5" → tipo="ADAP MACHO JIC X HEMBRA JIC", medidas=["1 1/4","1"], cantidad=5.
...
- Si el tipo de rosca aparece DOS VECES (aunque sea el mismo estándar) y no hay keywords "terminal"/"esp": es ADAPTADOR.
  ...
  Ej: "bushing 20 mj -16 fj = 5"              → tipo="ADAP MACHO JIC X HEMBRA JIC", medidas=["1 1/4","1"], cantidad=5  ← mj=Macho JIC, fj=Hembra JIC, bushing=adaptador
